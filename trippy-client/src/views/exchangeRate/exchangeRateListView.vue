  ...
  <div class="exchange-list w-11/12 flex flex-col h-full">
    ...
    <div v-else
      ...
      <ul class="divide-y divide-gray-200 flex-1 ">
        <li v-for="item in todayRates" :key="item.cur_unit" class="flex items-center justify-between py-4">
          <div class=" flex">
            <div class="w-10 ">
              <!-- 국기 표현 부분 -->
              <img :src="`https://flagcdn.com/w40/${getCountryCode(item.cur_unit)}.png`" :alt="item.cur_nm"
