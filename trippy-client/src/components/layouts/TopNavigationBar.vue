...
<template>
  <div class="bg-white h-[100px] w-full absolute fixed top-0">
    <div v-if="pageTitle === '홈'" class='h-[56px] px-4 mt-11 flex align-center items-center justify-between'>
    ...
    <div v-if="pageTitle !== '홈'" class='h-[56px] mt-11 flex items-center justify-between relative'>
